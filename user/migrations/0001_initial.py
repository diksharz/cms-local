    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('master', 'Master'), ('manager', 'Manager'), ('listing_team', 'Listing Team'), ('staff', 'Staff'), ('admin', 'Admin'), ('partner', 'Partner')], default='manager', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.TextField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_referral_code', models.CharField(blank=True, max_length=255, null=True)),
                ('login_otp', models.IntegerField(default=0)),
                ('login_otp_create', models.DateTimeField(blank=True, null=True)),
                ('rzp_contact_id', models.CharField(blank=True, max_length=255, null=True)),
                ('total_savings', models.FloatField(default=0)),
                ('regerral_code', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updation_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('facility', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='cms.facility')),
